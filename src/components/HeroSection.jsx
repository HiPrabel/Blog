...
const HeroSection = () => {
    return (
        <section className="w-full max-w-7xl mx-auto mb-4 h-auto sm:h-[40vh] flex flex-col justify-center items-center text-center bg-gray-100 text-gray-900 rounded-lg shadow-md p-6 relative overflow-hidden">
            ...
            <motion.p 
                ...
                className="text-lg max-w-2xl text-gray-600 leading-relaxed relative z-10">
            ...
            <Link to="/add-post">
                <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="mt-6 px-6 py-3 bg-blue-600 text-white font-semibold rounded-full shadow-lg hover:bg-blue-700 hover:shadow-xl transition-all duration-300 relative z-10">
                    Create Post
                </motion.button>
            </Link>
        </section>
